...
layui.define(["jquery","laytpl","layer"], function (exports) {
    ...
    Cascader.prototype={
        ...
        // 初始化容器和标签
        init: function () {
            // $(this.elem).after('<i class="layui-icon layui-icon-down" style="color: #c2c2c2;" data-cascader="elem"></i>');
            $(this.elem).after('<i class="layui-icon layui-icon-triangle-d" style="color: #c2c2c2;" data-cascader="elem"></i>');
        ...
        getBlockData: function (event,el) {
            ...
            /* --点击事件start（zhao）-- */
            if (!this.option.selectLastLevels) {
        ...
        finishInitData: function (triggerData) {
            ...
            $(this.elem).siblings("i").removeClass("layui-icon-triangle-u")

            // 如果有初始值，则第一次不回调
            if(triggerData!=="initValue" && this.option.selectLastLevels && this.option.success) this.option.success(this.valueArr,this.textArr);
            // this.count++;
        ...
        initValue: function() {
            ...
            if($.isArray(this.option.value) && this.option.value.length>0) {
                ...
                $(self.elem).siblings("i").removeClass("layui-icon-triangle-u")
        ...
        callback: function () {
            ...
            $(self.elem+","+self.elem+" ~ i.layui-icon").on("click.cascader", function () {
                ...
                if (self.onOff) {
                    ...
                    $(self.elem).siblings("i").addClass("layui-icon-triangle-u")
